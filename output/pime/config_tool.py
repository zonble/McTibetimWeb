...
config_dir = os.path.join(os.path.expandvars("%APPDATA%"), "PIME", "mctibetim")
localdata_dir = os.path.join(os.path.expandvars("%LOCALAPPDATA%"), "PIME", "mctibetim")

COOKIE_ID = "mctibetim_config_token"
SERVER_TIMEOUT = 120
DEFAULT_CONFIG = {
